...
import (
	...
	"fitness-trainer/internal/shared/logger"
	"fitness-trainer/internal/shared/utils"
...
type ContextManager interface {
	GetEngineFromContext(ctx context.Context) pgxscan.Querier
}
...
func NewUserRepository(contextManager ContextManager) *UserRepository {
	return &UserRepository{
		contextManager: contextManager,
	}
}

func (r *UserRepository) GetUserByID(ctx context.Context, id domain.ID) (domain.User, error) {
...
func (r *UserRepository) GetOrCreateUser(ctx context.Context, user domain.User) (domain.User, error) {
	span, ctx := opentracing.StartSpanFromContext(ctx, "UserRepository.GetOrCreateUser")
	defer span.Finish()
