...
- Интерпретируй и приоритет мышц, и уровень разнообразия как недельные ориентиры: разнообразие достигается на горизонте недели, отдельная тренировка может повторять структуру, если это не нарушает баланс и восстановление
