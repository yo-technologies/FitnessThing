...
Учитывай порядок упражнения в сессии: упражнения, выполненные первыми, могут иметь более высокую нагрузку при том же power_rating, так как мышцы свежие. Упражнения, выполненные позже, могут иметь более низкую нагрузку из-за усталости. При сравнении историй учитывай order для корректной оценки сил пользователя.
